...
export default function CheckInScreen({ onBack, eventoId, idEstande, onUserNotFound, fromDiscount, isKiosk = false, userName = '', userPhone = '' }) {
  ...
  if (eventoId === 'bett_brasil') {
    return <CheckInScreenBettBrasil onBack={onBack} eventoId={eventoId} idEstande={idEstande} fromDiscount={fromDiscount} isKiosk={isKiosk} userName={userName} userPhone={userPhone} />;
  }
